...
from source.gui.chart_config import (
    AnalysisLogField,
    BJHSeries,
    XBJH_DEFAULT,
...
from source.gui.chart_series import analysis_series, bjh_series
from source.gui.file_session import OpenFileSession
from source.gui.mpl_navigation_toolbar import MateryxAsapNavigationToolbar2QT
...
def _curve_gid_for_path(path: Path) -> str:
    ...
    return f"source:summary:curve:{path.as_posix()}"
...
class MultiAnalysisLogChartWidget(QWidget):
    ...
    def __init__(self, translator: Translator, parent: QWidget | None = None) -> None:
        ...
        self._toolbar = MateryxAsapNavigationToolbar2QT(
            self._canvas,
            self,
