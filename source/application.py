...
from source.gui.app_icons import application_icon
...
def create_application(argv: "QList[str] | list[str] | None" = None) -> QApplication:
    ...
    app.setOrganizationName("Materyx")
    app.setApplicationName("mx-asap")
    logger.debug("QApplication created with Fusion style and window icon")
    return app
